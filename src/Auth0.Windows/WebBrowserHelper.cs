/**
 * Code takne from here: http://stackoverflow.com/a/24401521/5192029
                ...
                do
                {
                    INTERNET_CACHE_ENTRY_INFOA internetCacheEntry =
                        (INTERNET_CACHE_ENTRY_INFOA)
                            Marshal.PtrToStructure(cacheEntryInfoBuffer, typeof(INTERNET_CACHE_ENTRY_INFOA));
                    ...
                    if (!more && Marshal.GetLastWin32Error() == ERROR_INSUFFICIENT_BUFFER)
                    {
                        ...
                        more = FindNextUrlCacheEntry(enumHandle, cacheEntryInfoBuffer,
